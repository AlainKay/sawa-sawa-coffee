        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg">
            <div className="flex items-start">
              ...
              <div>
                <h4 className="text-lg font-semibold text-blue-900 mb-2">Indicative Pricing</h4>
                <p className="text-blue-800 text-sm">
                  All pricing and shipping costs presented are indicative estimates based on current market conditions and are subject to change.
                  Final pricing will be confirmed upon formal quotation and is contingent upon volume commitments, payment terms, delivery schedules,
                  and prevailing market dynamics. Please contact our sales team for a detailed commercial proposal tailored to your specific requirements.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="mt-6 p-4 bg-amber-50 rounded-lg">
                  <p className="text-sm text-gray-700 mb-2">
                    <strong>Shipping (Indicative):</strong>
                  </p>
                  <p className="text-sm text-gray-700">
                    Dar es Salaam to Dubai/China: $3,000/container* | North America: $3,500 for 18 tons*
                  </p>
                </div>
                <div className="mt-4 p-3 bg-gray-100 rounded border-l-2 border-gray-400">
                  <p className="text-xs text-gray-600 italic">
                    * Indicative pricing subject to market fluctuations, volume, and contractual terms
                  </p>
                </div>
              </div>
            </div>
